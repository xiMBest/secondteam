...
import { PenaltyComponent } from 'app/entities/penalty/penalty.component';
import { PenaltyService } from 'app/entities/penalty/penalty.service';
import { Penalty } from 'app/shared/model/penalty.model';

describe('Component Tests', () => {
  describe('Penalty Management Component', () => {
    let comp: PenaltyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PenaltyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.penalties && comp.penalties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
