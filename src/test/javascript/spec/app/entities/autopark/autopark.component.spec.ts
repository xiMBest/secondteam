...
import { AutoparkComponent } from 'app/entities/autopark/autopark.component';
...
describe('Component Tests', () => {
  describe('Autopark Management Component', () => {
    let comp: AutoparkComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AutoparkComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.autoparks && comp.autoparks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
