...
import { FixcarComponent } from 'app/entities/fixcar/fixcar.component';
import { FixcarService } from 'app/entities/fixcar/fixcar.service';
import { Fixcar } from 'app/shared/model/fixcar.model';

describe('Component Tests', () => {
  describe('Fixcar Management Component', () => {
    let comp: FixcarComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FixcarComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fixcars && comp.fixcars[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
