...
import { ReservecarComponent } from 'app/entities/reservecar/reservecar.component';
...
describe('Component Tests', () => {
  describe('Reservecar Management Component', () => {
    let comp: ReservecarComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReservecarComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reservecars && comp.reservecars[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
